...
int main()
{
    ...
    while (keepRunning)
    {
        ...
        glm_quatv(pitchQuat, orqa_radians(opengl_cam.resultEuler.pitch), (vec3){1.0f, 0.0f, 0.0f});
        glm_quatv(yawQuat, orqa_radians(-opengl_cam.resultEuler.yaw + 180.0), (vec3){0.0f, 1.0f, 0.0f});
        glm_quatv(rollQuat, orqa_radians(opengl_cam.resultEuler.roll), (vec3){0.0f, 0.0f, 1.0f});
