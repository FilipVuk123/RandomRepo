...
double computeHeading(const double mag_x, const double mag_y, const double mag_z, const double accel_x, const double accel_y, const double accel_z)
{
	...
	const double scale = dot_vec3(vector_mag, vector_down) / dot_vec3(vector_down, vector_down) ? dot_vec3(vector_down, vector_down) != 0 : dot_vec3(vector_mag, vector_down);
