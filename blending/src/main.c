...
int main()
{
    ...
    orqa_bind_buffer_set_data(GL_ARRAY_BUFFER, VBOs[1], sizeof(vertices), vertices, GL_STATIC_DRAW);
    ...
    orqa_load_texture_from_file("DSS.png");

    orqa_bind_texture(textures[1]);
    orqa_load_texture_from_file("earth.jpg");
